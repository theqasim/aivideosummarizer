    ...
    <Card key="1" className="w-full max-w-3xl mx-auto">
      <CardHeader className="border-b">
        <div className="grid gap-1.5">
          ...
          <CardDescription>
            Ask me anything! I can help with FAQs, support requests, and more.
          </CardDescription>
        </div>
      </CardHeader>
            ...
            <div className="p-4 grid gap-4">
              <div className="space-y-2">
                ...
                <p className="text-sm leading-loose md:text-base/relaxed lg:text-base/relaxed xl:text-base/relaxed">
                  AcmeBot is an AI-powered chatbot designed to assist you with a
                  variety of tasks. Whether you have questions about our
                  products, need help troubleshooting an issue, or want to learn
                  more about our services, AcmeBot is here to help.
                </p>
              </div>
              <div className="space-y-2">
